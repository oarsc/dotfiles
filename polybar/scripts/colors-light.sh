...
change_color() {
	...
	* {
	...
	# dunst
	sed -i -e "s/^    separator_color = \"#.*/    separator_color = \"$SH6\"/g" $DFILE
	...
	sed -i -e "s/^     background = \"#.*/     background = \"$SH5\"/g" $DFILE
	sed -i -e "s/^     foreground = \"#.*/     foreground = \"#FFFFFF\"/g" $DFILE
...
if  [[ $1 = "--amber" ]]; then
	...
	BG="#FFFFFF"	FG="#000000"
	SH1="#222222"	SH2="#333333"	SH3="#444444"	SH4="#555555"
	SH5="#666666"	SH6="#777777"	SH7="#888888"	SH8="#999999"
	change_color
else
	cat <<- _EOF_
